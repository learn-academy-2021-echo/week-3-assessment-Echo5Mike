...
// const theSorter = fullArr1.sort((a,b) => a-b).filter(value =>{
//     return typeof value === "number" && value % 2 !== 0
...
describe("sortAndAdder", () => {
    ...
    it("function that takes in an array and returns an array of the accumulating sum", () => {
      expect(sortAndAdder(numbersToAdd1)).toEqual(output1)
      expect(sortAndAdder(numbersToAdd2)).toEqual(output2)
      expect(sortAndAdder(numbersToAdd3)).toEqual(output3)
    })
})
